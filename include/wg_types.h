...
enum WgPixelType
{
	...
	WG_PIXEL_BGR_8,				///< One byte of blue, green and red respectively in memory in exactly that order.
	WG_PIXEL_BGRA_8				///< One byte of blue, green, red and alpha respectively in memory in exactly that order.
};
